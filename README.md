# Cooling Load & BTU Estimation Tool
...
## Tools Used
- Microsoft Excel (Data Validation, IF, VLOOKUP)

## How to Use
1. Open the Excel file
2. Enter room parameters in the input section
3. View calculated results automatically
